...
class Db_conn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'suabbott'; //this will be your WCC username
      $dbUsr = 'suabbott';  //this will be your WCC username
      $dbPass = 'er2vuv6rPaXtXzQ'; //this will be the password found in the video.
