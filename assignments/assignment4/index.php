<?php
// Call the Calculator class and its calc method with various arguments
require_once "Calculator.php";

// Create an instance of the Calculator class
$Calculator = new Calculator();

// Call the calc method with different sets of arguments and store the results
$result = "";
...
// Basic HTML structure to display the results
?>
<!DOCTYPE html>
<html lang="en">
<head>
